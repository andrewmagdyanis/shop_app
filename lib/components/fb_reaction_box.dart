...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
  ...
  initAnimationBtnLike() {
    ...
    animControlBtnLongPress = AnimationController(
        vsync: this, duration: Duration(milliseconds: durationAnimationBtnLongPress));
    ...
    animControlBtnShortPress = AnimationController(
        vsync: this, duration: Duration(milliseconds: durationAnimationBtnShortPress));
  ...
  initAnimationBoxAndIcons() {
    animControlBox =
        AnimationController(vsync: this, duration: Duration(milliseconds: durationAnimationBox));
  ...
  initAnimationIconWhenDrag() {
    animControlIconWhenDrag = AnimationController(
        vsync: this, duration: Duration(milliseconds: durationAnimationIconWhenDrag));
  ...
  initAnimationIconWhenRelease() {
    animControlIconWhenRelease = AnimationController(
        vsync: this, duration: Duration(milliseconds: durationAnimationIconWhenRelease));
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  whichIconUserChoose == 1 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/like.gif')
                      : Container(),

                  // Icon love
                  whichIconUserChoose == 2 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/love.gif')
                      : Container(),

                  // Icon haha
                  whichIconUserChoose == 3 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/haha.gif')
                      : Container(),

                  // Icon Wow
                  whichIconUserChoose == 4 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/wow.gif')
                      : Container(),

                  // Icon sad
                  whichIconUserChoose == 5 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/sad.gif')
                      : Container(),

                  // Icon angry
                  whichIconUserChoose == 6 && !isDragging
                      ? containerOfGifReaction('assets/images/reactions/angry.gif')
                      : Container(),
  ...
  Widget containerOfGifReaction(String path2gif) {
    return Container(
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/images/reactions/ic_like_fill.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/images/reactions/ic_like_fill.png';
        case 2:
          return 'assets/images/reactions/love2.png';
        case 3:
          return 'assets/images/reactions/haha2.png';
        case 4:
          return 'assets/images/reactions/wow2.png';
        case 5:
          return 'assets/images/reactions/sad2.png';
        case 6:
          return 'assets/images/reactions/angry2.png';
        default:
          return 'assets/images/reactions/ic_like.png';
      }
    } else {
      return 'assets/images/reactions/ic_like.png';
    }
